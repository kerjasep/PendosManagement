...
const Card = class {
    ...
    render() {
        return (index.h(index.Host, { key: '92e643805fa0886d6a99a0082792af3ba1f4d441' }, index.h("div", { key: 'e2f5129d0123e6390aae5dac5388167ab91dc8f1', "aria-labelledby": "label", class: `card 
          ${this.noBtns ? 'noBtns' : ""}
          ${this.direction} 
