...
const NumberIndicator = class {
    ...
    render() {
        return (index.h("div", { key: 'af16f4f8e63099724193284682d9f9952dec93e5', "aria-label": 'a number indicator', class: `numberIndicator__container ${this.inverted ? 'inverted' : ""}` }, index.h("span", { key: 'c93586a3bc0fadf268c214088e624450cd0d83b0' }, index.h("slot", { key: '8ee72ea8dabc7801ed555b1f90fe738c5428e6ac' }))));
    }
};
