...
const CardHeadline = class {
    ...
    render() {
        return (index.h("div", { key: '9433ff789abb135f340b7597d4abac96d1fa9983', class: `card__headline-wrapper ${this.hasDesc ? 'withDesc' : ""}` }, index.h("div", { key: '0de5cdecbd7b8d518e2fdd51ed9d29dc0aee33e1', class: `card-headline ${this.direction} ${this.isHovered ? 'isHovered' : ""}` }, index.h("slot", { key: '00a616ae175bfe6d63e595b1363cee8cc895c7f2' }))));
    }
