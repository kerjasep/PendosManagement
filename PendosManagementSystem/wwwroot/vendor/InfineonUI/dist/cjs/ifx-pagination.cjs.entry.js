...
const Pagination = class {
    constructor(hostRef) {
        ...
        this.ifxNextPage = index.createEvent(this, "ifxNextPage", 7);
        this.ifxPrevPage = index.createEvent(this, "ifxPrevPage", 7);
    ...
    render() {
        return (index.h("div", { key: '69783cc7eaa8f47dfb1f53c718c8fd7f660e66d4', "aria-label": 'a pagination', "aria-value": this.currentPage, class: "container" }, index.h("div", { key: '057e7d840db0d7eb2e16da6119aa8bdf54999d48', class: 'items__per-page-wrapper' }, index.h("div", { key: '4b027d115d39a232642637e5e5cccaa6857a103d', class: 'items__per-page-label' }, "Results per Page"), index.h("div", { key: '822e1b9b2b2fe488a17ff25dfa535a1ad6e0cfe5', class: 'items__per-page-field' }, index.h("ifx-select", { key: '76565e2d30cab18cf66418b3e7dd331c2deb93d0', value: 'undefined', size: 's', placeholder: 'false', "show-search": 'false', "search-placeholder-value": 'Search...', disabled: false, error: false, "error-message": 'Error', label: '', "placeholder-value": 'Placeholder', options: '[{"value":"ten","label":"10","selected":true}, {"value":"Twenty","label":"20","selected":false}, {"value":"Thirty","label":"30","selected":false}]' }))), index.h("div", { key: '25a1179982861a7903fffd31b8e46ffd8e89b310', class: 'items__total-wrapper' }, index.h("div", { key: '2cbe9f653e3089c00d7feda1608131e115cd043e', class: 'page__numbers-wrapper' }, index.h("div", { key: '2d9a57292018657deed09235303f5b8ccb190402', class: "pagination" }, index.h("ifx-icon-button", { key: 'c3d36e037957fcd970bda7330314818a7e894856', variant: 'secondary', class: "prev", color: 'primary', icon: 'arrow-left-24' }), index.h("ol", { key: '1cc4831fec24d2fc5b03a7a96232af93d5f388d1' }, this.numberOfPages.map((item) => index.h("li", { class: `${this.internalPage === item ? 'active' : ""}` }, index.h("a", { href: undefined }, item)))), index.h("ifx-icon-button", { key: '37ff3804641f2c8e41efdb25f27d11aac29cb84b', class: "next", variant: 'secondary', color: 'primary', icon: 'arrow-right-24' }))))));
    }
...
//# sourceMappingURL=ifx-pagination.cjs.entry.js.map