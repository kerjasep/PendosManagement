...
const Link = class {
    ...
    render() {
        return (index.h("a", { key: '509d025ee650e4596ca4a75bdb03c218db4f8cd6', "aria-label": 'a navigation link button', href: this.internalHref, target: this.internalTarget, class: this.linkClassNames() }, index.h("slot", { key: '83e58bbd5203b98aec4b7dc8cb8e99c2c89aa62f' })));
    }
    getSizeClass() {
