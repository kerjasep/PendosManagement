...
const Checkbox = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '219d61be45d28a83518ba1a00dd3889a282b1cce', class: "checkbox__container" }, index.h("input", { key: 'aa4c37dc2f5b8fbc5013d35fa14ac15121feeca4', type: "checkbox", hidden: true, ref: (el) => (this.inputElement = el), checked: this.internalValue, onChange: this.handleCheckbox.bind(this), id: 'checkbox', value: `${this.internalValue}` }), index.h("div", { key: 'cb50e0379b2e6ba31fb2de1c16020cfbb6716db5', tabindex: "0", onClick: this.handleCheckbox.bind(this), onKeyDown: this.handleKeydown.bind(this), role: "checkbox" // role attribute
            ,
...
const DropdownSeparator = class {
    ...
    render() {
        return (index.h("div", { key: 'b2d40033813be83fc126165b6ed33f90366d6a39', class: 'dropdown-separator' }));
    }
};
...
//# sourceMappingURL=ifx-checkbox_2.cjs.entry.js.map