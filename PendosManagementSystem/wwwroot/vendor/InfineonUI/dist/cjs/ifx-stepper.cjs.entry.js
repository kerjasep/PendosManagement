...
const Stepper = class {
    ...
    render() {
        return (index.h("div", { key: 'cbfa38266ad7640a7a43f15796e5c6badf6900d3', "aria-label": 'a stepper', role: 'navigation', class: `stepper ${this.variant !== 'compact' ? 'default' : 'compact'} ${this.variant === 'compact' ? 'compact-' + this.indicatorPosition : ''}` }, 
        /* Progress bar for compact variant. */
        (this.variant === 'compact') &&
            index.h("div", { class: 'stepper-progress' }, index.h("div", { class: 'progress-detail' }, `${Math.min(this.internalActiveStep, this.stepsCount)} of ${this.stepsCount}`)), index.h("div", { key: '5102c5b9cf6ff0c4920c54fe79c2692dc9effa4e', class: `stepper-wrapper` }, index.h("slot", { key: '779b09ff03173a3bffd661c8ce44489202696241' }))));
    }
    ;
    componentDidRender() {
...
exports.ifx_stepper = Stepper;

//# sourceMappingURL=ifx-stepper.cjs.entry.js.map