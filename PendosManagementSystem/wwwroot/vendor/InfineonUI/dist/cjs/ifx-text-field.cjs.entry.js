...
const TextField = class {
    ...
    render() {
        return (index.h("div", { key: '765903be73fed4206aeb538d4642fea5a2091920', "aria-label": "a text field for user input", "aria-value": this.value, "aria-disabled": this.disabled, class: `textInput__container ${this.disabled ? 'disabled' : ""}` }, index.h("div", { key: 'eaaa7ae95a53eee509b624ba9b9cca961e0c34e4', class: "textInput__top-wrapper" }, index.h("label", { key: '09169382963601eb4dd7f563fa34d15dbb3bdaa0', htmlFor: "text-field" }, index.h("slot", { key: 'e20c3c6870fb950860bb22d50e06f6c180ac3ec6' }), this.optional && this.required ? (index.h("span", { class: "optional-required" }, "(optional) *")) : this.optional ? (index.h("span", { class: "optional" }, "(optional)")) : this.required ? (index.h("span", { class: "required" }, "*")) : null)), index.h("div", { key: '06f4f00ec31d5a5af403d20442046ee1a31aaa34', class: "textInput__bottom-wrapper" }, index.h("div", { key: 'a9833f5720bd8aae9cb2bab6d803a96fb6bab76f', class: "input-container" }, this.icon && (index.h("ifx-icon", { icon: this.icon })), index.h("input", { key: 'ef787cb590470fa91c67f2418d00ce6a94d41c64', ref: (el) => (this.inputElement = el), disabled: this.disabled, type: "text", id: 'text-field', value: this.value, onInput: () => this.handleInput(), placeholder: this.placeholder, maxlength: this.maxlength, class: `${this.icon ? 'icon' : ""}
                ${this.error ? 'error' : ""} 
              ${this.size === "s" ? "input-s" : ""}
              ${this.success ? "success" : ""}` })), this.caption && !this.error &&
            index.h("div", { class: `textInput__bottom-wrapper-caption ${this.disabled} ? disabled : ""` }, this.caption), this.error &&
            index.h("div", { class: "textInput__bottom-wrapper-caption error" }, this.caption))));
    }
...
TextField.style = IfxTextFieldStyle0;

exports.ifx_text_field = TextField;

//# sourceMappingURL=ifx-text-field.cjs.entry.js.map