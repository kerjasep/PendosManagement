...
const Spinner = class {
    ...
    getClassNames() {
        return index$1.classNames('spinner', this.size && `spinner ${this.getSizeClass()}`);
    }
};
Spinner.style = IfxSpinnerStyle0;

exports.ifx_spinner = Spinner;

//# sourceMappingURL=ifx-spinner.cjs.entry.js.map