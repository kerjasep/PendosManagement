...
const Navbar = class {
    constructor(hostRef) {
        ...
        this.ifxNavbarMobileMenuIsOpen = index.createEvent(this, "ifxNavbarMobileMenuIsOpen", 7);
        this.main = true;
        this.products = false;
