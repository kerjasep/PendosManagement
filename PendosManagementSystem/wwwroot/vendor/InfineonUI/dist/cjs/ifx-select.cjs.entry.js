...
const ChoicesJs = /*@__PURE__*/getDefaultExportFromCjs(choices.exports);
...
const Choices = class {
    ...
    render() {
        ...
        this.destroy();
        return (index.h("div", { key: '70e9893bfcc8a12540373c83c6a88a029596019d', class: `ifx-select-container` }, this.label ? (index.h("div", { class: "ifx-label-wrapper" }, index.h("span", null, this.label))) : null, index.h("div", { key: 'fb8bf540b45ce01155d2e963c717f12eee0155ce', class: `${choicesWrapperClass} 
            ${this.disabled ? 'disabled' : ''} 
            ${this.error ? 'error' : ''}`, onClick: this.disabled ? undefined : () => this.toggleDropdown(), onKeyDown: event => this.handleKeyDown(event) }, index.h("select", Object.assign({ key: 'b262d6c8129922f84c36b8a64ba7e4d41a2632dc', disabled: this.disabled }, attributes, { "data-trigger": true, onChange: () => this.handleChange() }), this.createSelectOptions(this.options)), index.h("div", { key: '5af9837e16d35a33f902a334f6e85a12260265cd', class: "ifx-choices__icon-wrapper-up" }, index.h("ifx-icon", { key: "icon-up", icon: "chevronup-16" })), index.h("div", { key: '0557113bcaa3aa1511711e0c1c4e18569fed25be', class: "ifx-choices__icon-wrapper-down" }, index.h("ifx-icon", { key: "icon-down", icon: "chevron-down-16" }))), this.error ? (index.h("div", { class: "ifx-error-message-wrapper" }, index.h("span", null, this.errorMessage))) : null));
    }
    toggleDropdown() {
    ...
    createSelectOptions(ifxOptions) {
        ...
        if (this.value !== 'undefined' || ((_a = this.selectedOption) === null || _a === void 0 ? void 0 : _a.value) !== '') {
            ...
            if (optionValueBasedOnAvailableOptions) {
                return [index.h("option", { value: optionValueBasedOnAvailableOptions.value }, optionValueBasedOnAvailableOptions.label)];
            }
        }
        // Assign a unique id for the placeholder
        return this.placeholder !== 'false' ? [index.h("option", { value: "" }, this.placeholderValue)] : [index.h("option", { value: "" })];
    }
