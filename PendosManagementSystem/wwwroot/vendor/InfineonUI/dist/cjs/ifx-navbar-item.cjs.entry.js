...
const NavbarItem = class {
    ...
    render() {
        return (index.h("div", { key: 'd3edcbe9d05b4c6b8f1d5cadea3da5acbaa4531a', class: "container", onMouseLeave: e => this.handleNestedLayerMenu(e), onMouseEnter: e => this.handleNestedLayerMenu(e) }, index.h("div", { key: 'cbbd0aca26d687e81f935207fc54ed3dcca19f71', class: "sub__layer-back-button" }, index.h("div", { key: '5ed5020694bb77f12427b08e974dd92184b742aa', class: "back__button-wrapper", onClick: () => this.returnToFirstLayer() }, index.h("ifx-icon", { key: 'ea32f4e13dc2cf8a9fcf55873df276c7f10914cd', icon: "arrow-left-16" }), index.h("span", { key: '57c1c2cde3050b571ed96f553dd07f26ed1cdcb8' }, "Back"))), index.h("a", { key: '13b1b74da717e40238c6dea43a4811989fe30540', href: this.internalHref, target: this.target, onClick: () => this.toggleItemMenu(), class: `navbar__item ${this.isSidebarMenuItem ? 'sidebarMenuItem' : ""} ${!this.showLabel ? 'removeLabel' : ""} ${this.isMenuItem ? 'menuItem' : ""} ${this.hasChildNavItems ? 'isParent' : ""}` }, index.h("div", { key: 'f3df2ab377b8aff412a7a8aacdf55450c20bc3c4', class: "inner__content-wrapper" }, index.h("div", { key: '7ff654399c1ed0a2184df48fb492cd1b3d289710', class: `navbar__container-right-content-navigation-item-icon-wrapper ${!this.icon ? "removeWrapper" : ""}` }, this.icon && index.h("ifx-icon", { icon: this.icon })), this.itemPosition === 'left'
            && this.hasChildNavItems
            && this.isMenuItem &&
            index.h("div", { class: "menuItemLeftIconWrapper" }, index.h("ifx-icon", { icon: "chevron-left-12" })), index.h("span", { key: '7daf323171e81fc5618a515ca4609d7aba97d097', class: "label__wrapper" }, index.h("slot", { key: '3451522e360b39d320389f0169ddc49addd78f56' }))), index.h("div", { key: '97ede4b2db2c6b2047da4fcacb69f2c1306d26b0', class: `navItemIconWrapper ${this.hasChildNavItems && !this.isMenuItem && !this.isSidebarMenuItem ? '' : "hide"}` }, index.h("ifx-icon", { key: '7a852df1e61f3f09249ce0b6c1fd85cfd9829690', icon: "chevron-down-12" })), index.h("div", { class: `menuItemRightIconWrapper ${((this.itemPosition === 'right' && this.hasChildNavItems && this.isMenuItem) || (this.isSidebarMenuItem && this.hasChildNavItems)) ? '' : "hide"}` }, index.h("ifx-icon", { icon: "chevron-right-12" }))), this.hasChildNavItems && !this.isSidebarMenuItem && index.h("ul", { class: 'navbar-menu' }, " ", index.h("slot", { name: "first__layer" }), " "), this.isSidebarMenuItem && index.h("ul", { class: 'sub__layer-menu' }, " ", index.h("slot", { name: "second__layer" }), " ")));
    }
