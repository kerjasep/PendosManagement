...
const DropdownMenu = class {
    ...
    render() {
        return (index.h("div", { key: '24583268df1fced1b9346399e0b97f8a2ff4259b', class: `dropdown-menu 
      ${this.isOpen ? 'show' : ''} 
      ${this.hideTopPadding ? 'hideTopPadding' : ""}
      ${this.size === 's' ? 'small' : ""}` }, index.h("slot", { key: '7497285c6cb5c7540a0588e6a594efd1900227d8' })));
    }
