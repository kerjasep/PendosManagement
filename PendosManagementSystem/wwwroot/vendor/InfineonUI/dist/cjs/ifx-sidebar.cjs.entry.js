...
const Sidebar = class {
    constructor(hostRef) {
        ...
        this.copyrightText = '© 1999 - ' + this.currentYear + ' Infineon Technologies AG';
        this.internalTermsofUse = "";
        this.internalImprint = "";
        this.internalPrivacyPolicy = "";
        this.internalShowFooter = true;
    ...
    getSidebarMenuItems(el = this.el) {
        ...
        if (sidebarItems.length === 0) {
            return (_a = el.shadowRoot) === null || _a === void 0 ? void 0 : _a.querySelectorAll('ifx-sidebar-item');
        }
        return sidebarItems;
    }
    ...
    hasChildren(el) {
        return (el === null || el === void 0 ? void 0 : el.querySelector('.item__arrow-wrapper')) !== null ? true : false;
    }
    ...
    applyActiveSectionToParent(el) {
        ...
        subMenus === null || subMenus === void 0 ? void 0 : subMenus.forEach(menu => {
