...
const DatePicker = class {
    ...
    render() {
        return (index.h("div", { key: '177307ac5be8987028627ed003fe8dade70faf2a', class: `input__wrapper ${this.size === 'l' ? 'large' : 'small'} ${this.disabled ? 'disabled' : ""}` }, index.h("input", { key: '74216ec4152dafa0e501226e658f3df4ac357695', class: `date__picker-input ${this.error ? 'error' : ""} ${this.success ? "success" : ""}`, type: "date", disabled: this.disabled, onChange: (e) => this.getDate(e) }), index.h("div", { key: '2643aaf8597d47900e07a61c8dcb1375f116fb28', class: "icon__wrapper", onClick: () => this.handleInputFocusOnIconClick() }, index.h("ifx-icon", { key: 'cffcf69ab5ce99ccad8335a5cb1ba749dacd259c', icon: 'calendar16' }))));
    }
...
exports.ifx_date_picker = DatePicker;

//# sourceMappingURL=ifx-date-picker.cjs.entry.js.map