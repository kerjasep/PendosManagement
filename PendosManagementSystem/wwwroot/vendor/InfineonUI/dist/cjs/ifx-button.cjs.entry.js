...
const Button = class {
    ...
    render() {
        return (index.h(index.Host, { key: '03197977641a301cea15a352d821cdb88bb2f6c7' }, index.h("a", { key: '5d3bcf0919eddea896a3b956577a3e691799e1fd', tabIndex: 0, ref: (el) => (this.focusableElement = el), class: this.getClassNames(), href: !this.disabled ? this.internalHref : undefined, target: this.target, onClick: this.handleClick, rel: this.target === '_blank' ? 'noopener noreferrer' : undefined, onFocus: (event) => this.handleFocus(event), "aria-disabled": this.disabled, "aria-labelledby": "label" }, index.h("slot", { key: 'f3b616d292965f93c27f71c9db122b82b4fc3934' }))));
    }
    getVariantClass() {
