...
<path fill-rule="evenodd" clip-rule="evenodd" d="M24 14C21.7909 14 20 15.7909 20 18C20 20.2091 21.7909 22 24 22C26.2091 22 28 20.2091 28 18C28 15.7909 26.2091 14 24 14ZM18 18C18 14.6863 20.6863 12 24 12C27.3137 12 30 14.6863 30 18C30 21.3137 27.3137 24 24 24C20.6863 24 18 21.3137 18 18ZM16.5869 28.3984C18.2683 27.0179 20.7466 26 24 26C27.2541 26 29.7324 27.0209 31.4134 28.4024C33.0562 29.7526 34 31.5119 34 33V35C34 35.5523 33.5523 36 33 36H15C14.4477 36 14 35.5523 14 35V33C14 31.5074 14.9433 29.7479 16.5869 28.3984ZM17.8561 29.9441C16.5187 31.0421 16 32.2826 16 33V34H32V33C32 32.2881 31.4818 31.0474 30.1436 29.9476C28.8436 28.8791 26.8219 28 24 28C21.1774 28 19.1557 28.8771 17.8561 29.9441Z" fill="white"/>
    ...
    render() {
        return (index.h("div", { key: '707ce533344c2700ba177bc04e7ebfb6718ced69', class: "container" }, index.h("a", { key: '2e86f3d208362e8c9a9732d7a5f89be9256ed087', href: this.internalHref, target: this.target, onClick: () => this.toggleItemMenu(), class: `navbar__item ${!this.showLabel ? 'removeLabel' : ""} ${this.hasChildNavItems ? 'isParent' : ""}` }, index.h("div", { key: '21783737bb527c48af397c46b86ba9a4d0747106', class: "inner__content-wrapper" }, index.h("div", { key: '22082a3ea885f0672f4e22ebba0615d2207af004', class: `navbar__container-right-content-navigation-item-icon-wrapper` }, this.userName.trim() !== "" && index.h("div", { class: 'username__tooltip' }, this.userName), this.internalImageUrl.type !== 'initials' &&
            index.h("img", { src: this.internalImageUrl.type === 'url' ? this.internalImageUrl.value : `data:image/svg+xml,${encodeURIComponent(this.defaultProfileImage)}`, alt: this.alt }), this.internalImageUrl.type === 'initials' &&
            index.h("div", { class: "initials__wrapper" }, index.h("span", { class: "initials" }, this.internalImageUrl.value))), index.h("span", { key: 'f29c576cb560fe4b9fbc38c1bd7147db03bdf2c2', class: "label__wrapper" }, index.h("slot", { key: 'bf228e154dc21eefff0f98a0bc0dd779f48c41d3', onSlotchange: () => this.setProfileGap() })))), this.hasChildNavItems && index.h("ul", { class: 'navbar-menu rightSideItemMenu' }, " ", index.h("slot", { name: "first__layer" }), " ")));
    }
    static get assetsDirs() { return ["assets"]; }
    get el() { return index.getElement(this); }
};
NavbarProfile.style = IfxNavbarProfileStyle0;

exports.ifx_navbar_profile = NavbarProfile;

//# sourceMappingURL=ifx-navbar-profile.cjs.entry.js.map