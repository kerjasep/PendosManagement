...
const IconsPreview = class {
    ...
    render() {
        return (index.h("div", { key: 'abba7c322a84b78d080e0a12c7995a99b5eb6d22', class: 'container' }, index.h("div", { key: 'c7997ba6c8cb2a3fe8fdc9c5d3a9fe8db8137899', class: 'html-wrapper' }, index.h("span", { key: 'ea69c5821233fa40ef11ef3ac14d886965c5a575', class: "html-tag" }, "<"), index.h("span", { key: 'c975541065694eec75fc0ad679ba7a809e0b92d1', class: "component-name" }, "ifx-icon"), index.h("span", { key: 'e7cffd3b37454da3c457a2c3c59ba352d0b7c083', class: "attribute-name" }, " icon"), "=", index.h("span", { key: 'fa072b8a61095aa4b383c035a0fae6596a86fc86', class: "attribute-value" }, this.iconName), index.h("span", { key: '9e672339a4df1572c224fe35d202d831d8e888ef', class: "html-tag" }, ">"), index.h("span", { key: 'abd9f0b60204110643fd63c81d34be8ec4e8f918', class: "html-tag" }, "</"), index.h("span", { key: '73beab1226410965f5f350d0e5f620776999d3e5', class: "component-name" }, "ifx-icon"), index.h("span", { key: 'a177a1cee309c17df06b0af920777204cdf2bf5f', class: "html-tag" }, ">"), index.h("button", { key: '11530b8d08d49aad5d3de211708692aa3a0b0e40', onClick: () => this.copyHtmlString() }, this.isCopied ? 'Copied' : 'Copy')), index.h("div", { key: 'c01d434a0c4668b846e1b5c8719f614261556fd4', class: "preview__container" }, this.iconsArray.map((icon, index$1) => index.h("div", { class: `preview__container-item ${this.isCopied && this.copiedIndex === index$1 ? 'copied' : ""}`, onClick: () => this.copyIconText(icon) }, index.h("ifx-icon", { icon: icon }))))));
    }
    get el() { return index.getElement(this); }
};
IconsPreview.style = IfxIconsPreviewStyle0;
