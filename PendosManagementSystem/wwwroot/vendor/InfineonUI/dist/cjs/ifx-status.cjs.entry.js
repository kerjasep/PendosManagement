...
const Status = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '281adf99c2351d42be81b120fce2afc35a39dc8a', "aria-label": "a status indicator", "aria-value": this.label, class: containerClass }, index.h("span", { key: '1f3485e7683f72fdd433cd90ea705ae398a38ea1', class: `dot ${this.color}` }), index.h("p", { key: 'd1f808310311891d4baf621ac84965dd9b2db311', class: "text" }, this.label)));
    }
};
Status.style = IfxStatusStyle0;

exports.ifx_status = Status;

//# sourceMappingURL=ifx-status.cjs.entry.js.map