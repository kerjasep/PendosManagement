...
const IfxSlider = class {
    ...
    render() {
        return (index.h("div", { key: '97c393e3b354c418466ffc4250cee09c41a2d2ff', class: "ifx-slider" }, this.leftText && (index.h("span", { class: `left-text` }, this.leftText)), this.leftIcon && (index.h("ifx-icon", { icon: this.leftIcon, class: `left-icon${this.disabled ? ' disabled' : ''}` })), (this.type !== 'double') ?
