...
const Accordion = class {
    ...
    render() {
        return (index.h("div", { key: '975256f6d34c36f5eecdcedab9c4f05227336626', class: "accordion-wrapper" }, index.h("slot", { key: '10cf4057057d95596240cc83fb3f6d9c1fe3e4e2' })));
    }
...
const IfxAccordionItem = class {
    ...
    render() {
        return (index.h("div", { key: '07f1b7982c1f9d5ff86afe165cb170f38b546944', "aria-label": this.caption, class: `accordion-item ${this.internalOpen ? 'open' : ''}` }, index.h("div", { key: '1f6268a5392e0a8f772bd4ba6c34087982b16e2e', class: "accordion-title", onClick: () => this.toggleOpen() }, index.h("span", { key: 'f05542ae5676a9e1c71da72c6594577494cabf9a', class: "accordion-icon" }, index.h("ifx-icon", { key: '6ef259ee86a0f967e885102559668d0f22459f54', icon: "chevron-down-12" })), index.h("span", { key: 'f62dc7583d81420c558e923d52f8932a8ebc0ca1', class: "accordion-caption" }, this.caption)), index.h("div", { key: '381b7e40f5cc202f0697e93157883c4546fd4542', class: "accordion-content", ref: (el) => (this.contentEl = el) }, index.h("div", { key: '0b27bed885f8ef477ebf66510759ab041f6e4873', class: "inner-content" }, index.h("slot", { key: '8e7293105ae43e904346cb8bf9cf5a17d092ac86', onSlotchange: (e) => this.handleSlotChange(e) })))));
    }
