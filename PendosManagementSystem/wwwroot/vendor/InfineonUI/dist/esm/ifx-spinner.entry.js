...
const Spinner = class {
    ...
    render() {
        return (h("div", { key: '520db036dbce798b394d61051f01cb802739c051', "aria-label": "spinner indicating a loading process", class: this.getClassNames() }, h("div", { key: '924f6ac1c53f03427c243776bf39ee537e7fb089', class: `${this.variant !== 'brand' ? 'border' : ""} ${this.inverted ? 'inverted' : ""}` }), this.variant === 'brand'
...
export { Spinner as ifx_spinner };

//# sourceMappingURL=ifx-spinner.entry.js.map