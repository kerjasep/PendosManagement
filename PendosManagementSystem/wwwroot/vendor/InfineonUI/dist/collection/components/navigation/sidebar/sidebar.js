...
export class Sidebar {
    ...
    static get properties() {
        return {
            ...
            "copyrightText": {
                ...
                "reflect": false,
                "defaultValue": "'\u00A9 1999 - ' + this.currentYear + ' Infineon Technologies AG'"
            }
        };
    }
    static get states() {
    ...
    static get listeners() {
        return [{
                "name": "ifxSidebarMenu",
                "method": "handleSidebarItemInteraction",
                "target": undefined,
                "capture": false,
                "passive": false
            }, {
                "name": "ifxSidebarNavigationItem",
                "method": "handleSidebarItemActivated",
                "target": undefined,
                "capture": false,
                "passive": false
            }];
